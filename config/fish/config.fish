...
# `bin` is generated by daveyutils' `make`: symlinks to the scripts plus the
# compiled binaries. It won't exist until `make` has been run there.
if test -d $HOME/projects/daveyutils/bin
    fish_add_path $HOME/projects/daveyutils/bin
end
