...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="tokyonight-moon"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/h_/ybsz_np149d8nj8bhnt1k0zc0000gp/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/dhughes/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/dhughes/.mailcheckrc"
# }
